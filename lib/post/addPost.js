...
export default function addPost(post) {
    const { isEmergency, emiratesId,comunity_id,comunity_name, uid ,recipientDescription,userName,email, date, totaldonate, title, document, thumbnail ,profileImg ,type } = post;
